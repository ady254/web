        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="text-white font-bold text-2xl mb-6">
              Dev<span className="text-accent-400">Nexus</span>
            </div>
            <p className="text-gray-300 mb-6">
              We create digital experiences that inspire, engage, and deliver results. Our team of experts combine creativity and technology to transform your vision into reality.
            </p>
            ...
            <form className="mb-4">
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-4 py-2 rounded-l-md bg-primary-800 text-white border border-primary-700 focus:outline-none focus:border-accent-400"
                />
                <button
                  type="submit"
                  className="px-4 py-2 bg-accent-400 text-white rounded-r-md hover:bg-accent-500 transition-colors flex items-center"
                >
